...
import {FileTable} from '@pages/File/FileTable';
...
import CreateFile from "@pages/File/CreateFile.jsx";

export default function Index({canCreate, canEdit, canDelete, canAddFileToGroups}) {
    ...
    const {data: files, isLoading, refetch} = useQuery(
        ['files', filters],
        () => getFiles({pageSize: pageMeta?.size, page: pageMeta?.page, query: pageMeta.q, ...filters}),
        {
            enabled: false,
    ...
    return (
        <Layout title='File List'>
            ...
            <CreateFile show={showAddModal} setShow={setShowAddModal} refreshFiles={refetch} />
        </Layout>
    )
}
...
const getFiles = async ({pageSize, page, query, ...filters}) => {
