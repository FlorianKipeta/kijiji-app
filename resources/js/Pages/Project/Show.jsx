                    ...
                    <div style={{height: 'calc(100vh - 130px)'}}>
                        <div className="card mb-4">
                            <div className="flex border-b pb-4">
                                <h2 className="text-black font-bold flex-1">{project?.name} - Profile</h2>
                            ...
                            <div className="py-3 sm:grid sm:grid-cols-3 sm:gap-4">
                                ...
                                <dd className="mt-1 text-sm text-gray-800 sm:mt-0 sm:col-span-2">{project?.name}</dd>
                            </div>
                            <div className="py-3 sm:grid sm:grid-cols-3 sm:gap-4">
                                <dt className="text-sm font-medium text-gray-500">Phone</dt>
                                <dd className="mt-1 text-sm text-gray-800 sm:mt-0 sm:col-span-2">{project?.phone}</dd>
                            </div>
                        </div>
